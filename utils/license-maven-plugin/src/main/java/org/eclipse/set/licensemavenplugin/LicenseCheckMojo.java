 ...
 *************************************************************************/
// Adapted from https://github.com/eclipse/dash-licenses/blob/master/maven-plugin/src/main/java/org/eclipse/dash/licenses/maven/LicenseCheckMojo.java
...
public class LicenseCheckMojo extends AbstractArtifactFilteringMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		// reactor
		final Set<Artifact> filteredArtifacts = new HashSet<>();
		...
		final List<IContentId> deps = new ArrayList<>();
		...
		final List<IResultsCollector> collectors = new ArrayList<>();
